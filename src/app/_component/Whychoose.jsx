        ...
        <Wrapper>
            <div className="container mx-auto px-4">
                ...
                <div className="mb-12 md:mb-16 flex flex-col items-center justify-center">
                    ...
                    <div className='bg-[var(--maincolor)] w-32 h-1 rounded-full mt-2 '></div>
                </div>
                        ...
                        {features.map((feature, index) => (
                            ...
                            >
                                <div className="flex items-center mb-4">
                                    <div className="mr-4 bg-[var(--lightcolor)] p-2 rounded-full">
                                  <feature.icon color='var(--maincolor)' size={35} />
                                    </div>
