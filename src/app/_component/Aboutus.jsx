            ...
            <Wrapper>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    ...
                    <section className='relative'>
                        ...
                        <div className='p-8 absolute bg-[var(--maincolor)] rounded-lg text-white text-xl left-2 bottom-[-80px] flex lg:flex md:hidden lg:bottom-2 lg:left-[-80px]'>
